...
//        System.out.println(Arrays.toString(cm));
        ...
        if (species.equals("pet") && numberAnimal == 1) arrayAnimal.add(new Cat(id, name, bornDate, species, cm));
        else if (species.equals("pet") && numberAnimal == 2) arrayAnimal.add(new Dog(id, name, bornDate, species, cm));
        else if (species.equals("pet") && numberAnimal == 3) arrayAnimal.add(new Hamster(id, name, bornDate, species, cm));
        else if(species.equals("pack") && numberAnimal == 4) arrayAnimal.add(new Horse(id, name, bornDate, species, cm));
            ...
            System.out.println(id +"=id" + name + "=name"+" по данному питомцу постарайтесь ввести корректные данные: 'pet' или 'pack' и numberAnimal: 1...6");
        }
